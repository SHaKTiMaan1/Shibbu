...
class MainWindow(QMainWindow):
    ...
    def Button(self):
        ...
        if btnWidget.objectName() == "add_dataset_button":
            ...
            btnWidget.setStyleSheet(UIFunctions.selectMenu(btnWidget.styleSheet()))
            header = ButtonHeaderView(self.ui.tableWidget_2)
            self.ui.tableWidget_2.setVerticalHeader(header)
            self.ui.tableWidget_2.setHorizontalHeaderLabels(["S.No","C_ID","Add Data"])
            header_buttons = []
            for i in range(self.ui.tableWidget_2.columnCount()):
                header_button = "+"
                header_buttons.append(header_button)
            self.ui.tableWidget_2.setVerticalHeaderLabels(header_buttons)
